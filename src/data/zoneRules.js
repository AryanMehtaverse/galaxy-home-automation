// Auto-suggestion rules for zone names
// When a zone is named, keywords are matched and products suggested
...
// Match zone name against rules, return all matching suggestions
export function getZoneSuggestions(zoneName) {
