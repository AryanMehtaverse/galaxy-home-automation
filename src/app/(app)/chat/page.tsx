    ...
    <div className="flex flex-col h-full bg-zinc-50 dark:bg-zinc-950">
      ...
      <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-4 py-3 shrink-0">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#C9A840] text-zinc-950 shrink-0">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        {messages.map((msg) => (
          <div key={msg.id} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
            {msg.role === "bot" && (
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#C9A840] text-zinc-950 mr-2 mt-0.5">
                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                </svg>
              </div>
            ...
            <div className={`max-w-[75%] ${msg.role === "user" ? "max-w-[65%]" : ""}`}>
              <div
                className={`rounded-2xl px-4 py-2.5 text-sm leading-relaxed ${
                  msg.role === "user"
                    ? "bg-[#C9A840] text-zinc-950 rounded-tr-sm whitespace-pre-wrap"
                    : msg.error
                  ...
                  {msg.answeredBy && (
                    <span className={`ml-1.5 rounded px-1.5 py-0.5 text-[10px] font-medium ${
                      msg.answeredBy === "ollama"
                        ...
                        : "bg-[#C9A84020] text-[#A07820] dark:bg-[#C9A84020] dark:text-[#C9A840]"
                    }`}>
      ...
      <div className="shrink-0 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-4 py-3">
        <div className="flex items-end gap-2 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 px-3 py-2 focus-within:border-amber-500 dark:focus-within:border-amber-500 transition-colors">
          ...
          <button
            ...
            className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#C9A840] text-zinc-950 hover:bg-[#A07820] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
