...
import { updateSiteAssignment } from "@/lib/firestore/siteOperations";
import { useAuthContext } from "@/components/providers/AuthProvider";
import type { SiteAssignment, SitePriority } from "@/types/site";
import { PRIORITIES } from "./siteOperationsConstants";

export function EditSiteAssignmentModal({ assignment, onClose, managers }: {
